    ...
    WebViewClient webViewClient = new WebViewClient() {
        ...
        public void onPageFinished(WebView view, String url) {
            if(!url.contains("#")){
                String jsRefresh;
                if (refresh_type==1) {
                    jsRefresh = "var intervalId = null;intervalId = setInterval(function(){ if (document.getElementsByClassName(\"js-12-d js-13-2r\").length!=0) { document.getElementsByClassName(\"js-12-d js-13-2r\")[2].insertAdjacentHTML(\"afterend\", '<button onclick=\"javascript: location.reload();\" type=\"button\" class=\"js-51-24 js-52-25 js-53-26 js-54-27 js-29-17 js-48-21 js-7-1j js-40-1k js-6-18 js-30-19 js-31-1a js-32-1b js-33-1c js-8-8 js-34-1d js-35-1e js-36-1f js-37-1g js-38-1h js-39-1i js-16-j js-41-1l js-42-1m js-43-1n js-44-1o js-45-1p\"><svg style=\"height: 20px; width: 20px; color: rgb(0, 0, 255);\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 24 512 512\"><path d=\"M256,48C141.31,48,48,141.32,48,256c0,114.86,93.14,208,208,208,114.69,0,208-93.31,208-208C464,141.13,370.87,48,256,48Zm94,219a94,94,0,1,1-94-94h4.21l-24-24L256,129.2,315.8,189,256,248.8,236.2,229l27.92-27.92C261.72,201,259,201,256,201a66,66,0,1,0,66,66V253h28Z\"></path></svg></button>'); clearInterval(intervalId); document.styleSheets[document.styleSheets.length-1].addRule(\".js-48-3x\", \"border:none;\");document.styleSheets[document.styleSheets.length-1].addRule(\".js-68-43\", \"border-left-style: none;border-bottom:1px dashed grey;\");}}, 10);";
                }else{
